...
describe('deduplicacion al subir rangos solapados', () => {
  it('reconoce el mismo movimiento leido dos veces', () => {
    const a = t('2026-05-24', 'Transf. via MB a 839453461', -30, '0000839453461')
    const b = t('2026-05-24', 'Transf. via MB a 839453461', -30, '0000839453461')
    expect(huellaDe(a)).toBe(huellaDe(b))
  })

  it('distingue dos cargos iguales del mismo dia con referencia distinta', () => {
    const a = t('2026-05-30', 'PagoTC Via MB***3208', -20000, '0000000003208')
    const b = t('2026-05-30', 'PagoTC Via MB***3208', -20000, '0000000009999')
    expect(huellaDe(a)).not.toBe(huellaDe(b))
  })

  it('separa lo nuevo de lo ya guardado', () => {
    const yaGuardado = [t('2026-05-24', 'Transf. via MB a 839453461', -30)]
    const nuevoLote = [
      t('2026-05-24', 'Transf. via MB a 839453461', -30), // repetido
  ...
  it('tambien limpia duplicados dentro del mismo lote', () => {
    const lote = [
      t('2026-05-24', 'Transf. via MB a 839453461', -30),
      t('2026-05-24', 'Transf. via MB a 839453461', -30),
    ]
